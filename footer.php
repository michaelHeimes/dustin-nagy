...
?>
				...
				<footer id="colophon" class="site-footer bg-black text-center medium-text-left">
					<div class="grid-container">
						<?php if( $footer_logo ):?>
							<div class="grid-x grid-padding-x align-center text-center">
								<div class="footer-logo-wrap cell small-12">
						...
						<?php endif;?>
						<div class="footer-main grid-x grid-padding-x align-center tablet-align-justify">
							<?php if( $footer_locations || $footer_telephone_number || $footer_email_address ):?>
								<div class="footer-col cell small-12 tablet-3 show-for-large">
							...
							<div class="cell small-12 medium-6 tablet-3 large-shrink">
								<?php trailhead_footer_stacked_nav();?>
							</div>
							<?php if( $footer_locations || $footer_telephone_number || $footer_email_address ):?>
								<div class="footer-col cell shrink medium-6 tablet-12 hide-for-large">
									<?php if( $footer_locations ):?>
										<div class="locations">
											<?php foreach($footer_locations as $location):
												$title = $location['title'] ?? null;
